...
public class HyphenationUKTestOld {
    ...
    public void before() {
        try {
            ...
            //hyphenator.loadTable(new FileReader("ushyph.tex"));
            hyphenator.loadTable(new FileInputStream("ukhyph.tex"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private String hyph(String hyph) {
        return hyphenator.hyphenate(hyph, 2, 3);
    }
    @Test
